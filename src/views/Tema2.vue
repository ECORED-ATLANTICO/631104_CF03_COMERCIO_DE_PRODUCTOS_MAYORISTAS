...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-5 En adición es de vital importancia identificar el entorno, los diseños de producción, los gustos, y las diferentes motivaciones que se generan en los clientes, para de esta manera adaptar las actividades del comercio mayorista al entorno y los objetivos planteados por el mercado.
    
    .titulo-con-imagen.mb-5(data-aos="fade-right")
      .titulo-con-imagen__fondo
        img.titulo-con-imagen__imagen(src="@/assets/componentes/1.svg")
        h3.titulo-con-imagen__texto Clientes minoristas y detallistas
    ...
    .titulo-con-imagen.mb-5(data-aos="fade-right")
      .titulo-con-imagen__fondo
        ...
        h3.titulo-con-imagen__texto Clientes mayoristas
    ...
    .titulo-con-imagen.mb-5(data-aos="fade-right")
      .titulo-con-imagen__fondo
        img.titulo-con-imagen__imagen(src="@/assets/componentes/3.svg")
        h3.titulo-con-imagen__texto Tipos de Clientes
  ...
  .container.bg-white.p-md-5.p-4.container-bottom.mt-0.cs.mb-3
    ...
    .titulo-con-imagen.mb-5(data-aos="fade-right")
      .titulo-con-imagen__fondo
        img.titulo-con-imagen__imagen(src="@/assets/componentes/4.svg")
        h3.titulo-con-imagen__texto Las necesidades de los clientes
    ...
    .titulo-con-imagen.mb-5(data-aos="fade-right")
      .titulo-con-imagen__fondo
        img.titulo-con-imagen__imagen(src="@/assets/componentes/5.svg")
        h3.titulo-con-imagen__texto Bases de datos de clientes
    ...
    .row.aling  
      .col-lg-12
        ...
        p.mb-5 Por lo anterior, se hace necesario revisar algunos conceptos claves para realizar la prospección de los clientes que se deben tener en cuenta, a saber.

    .titulo-con-imagen.mb-5(data-aos="fade-right")
      .titulo-con-imagen__fondo
        img.titulo-con-imagen__imagen(src="@/assets/componentes/6.svg")
    ...
    .titulo-con-imagen.mb-5(data-aos="fade-right")
      .titulo-con-imagen__fondo
        img.titulo-con-imagen__imagen(src="@/assets/componentes/7.svg")
    ...
    .titulo-con-imagen.mb-5(data-aos="fade-right")
      .titulo-con-imagen__fondo
        img.titulo-con-imagen__imagen(src="@/assets/componentes/8.svg")
        h3.titulo-con-imagen__texto Técnicas de prospección
    ...
    .titulo-con-imagen.mb-5(data-aos="fade-right")
      .titulo-con-imagen__fondo
        img.titulo-con-imagen__imagen(src="@/assets/componentes/9.svg")
        h3.titulo-con-imagen__texto Prospección persona a persona
    ...
    .titulo-con-imagen.mb-5(data-aos="fade-right")
      .titulo-con-imagen__fondo
        img.titulo-con-imagen__imagen(src="@/assets/componentes/10.svg")
        h3.titulo-con-imagen__texto Tipos de servicio al cliente
    ...
    .titulo-con-imagen.mb-5(data-aos="fade-right")
      .titulo-con-imagen__fondo
        img.titulo-con-imagen__imagen(src="@/assets/componentes/11.svg")
        h3.titulo-con-imagen__texto Productos y servicios, ¿en qué se diferencian?
