...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      ...
      .col-lg-10    
        .jumbotron-1.p-4(data-aos="zoom-in-down")    
          .row.justify-content-center.align-items-center
            .col-lg-8
              p.text-center.mb-4 Estas características se fundamentan principalmente en la capacidad que han tenido los altos directivos para tomar las decisiones correctas y gestionar adecuadamente los recursos con los que cuentan sus organizaciones, incluyendo:
            .row.justify-content-center.align-items-center
              .col-lg-4
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10    
        .jumbotron-1.p-4(data-aos="zoom-in-down")    
          .row.justify-content-center.align-items-center
            .col-lg-8
              p.text-center.mb-4 Teniendo en cuenta lo anterior, se hace necesario identificar de dónde proceden los datos y de qué tipo de fuente se originan, estos entonces proceden de:
            .row.justify-content-center.align-items-center
              .col-lg-4
                .jumbotron-2.p-3.mb-3
                  .row.align-items-center
    ...
    .row.justify-content-center.mb-5
      .col-xl-3.col-lg-6.col-md-9.col-11.mb-4.mb-xl-0
        .crd_hover_txt(data-aos="flip-left").tarjeta
          .crd_hover_txt--img
            figure
              img(src="@/assets/curso/images/tema3/fl_1.png", alt="alt")
          .crd_hover_txt--body
            h4.mb-3 Índice
            p.mb-0 Señala el contenido del reporte y se numeran las páginas que lo integran.
      ...
      .col-xl-3.col-lg-6.col-md-9.col-11.mb-4.mb-xl-0
        .crd_hover_txt(data-aos="flip-left").tarjeta
          .crd_hover_txt--img
            figure
              img(src="@/assets/curso/images/tema3/fl_3.png", alt="alt")
          .crd_hover_txt--body
            h4.mb-3 Desarrollo
            p.mb-0 Es el cuerpo del reporte, se desarrolla el tema del mismo de manera congruente, ordenada y clara.
      .col-xl-3.col-lg-6.col-md-9.col-11.mb-4.mb-xl-0
        .crd_hover_txt(data-aos="flip-left").tarjeta
          .crd_hover_txt--img
            figure
              img(src="@/assets/curso/images/tema3/fl_4.png", alt="alt")
          .crd_hover_txt--body
            h4.mb-3 Conclusión o resultados
            p.mb-0 Se resaltan los puntos o resultados más importantes que evidencia el reporte.
    ...
    .titulo-con-imagen.mb-5(data-aos="fade-right")
      .titulo-con-imagen__fondo
        img.titulo-con-imagen__imagen(src="@/assets/componentes/13.svg")
        h3.titulo-con-imagen__texto Conceptos básicos de base de datos
